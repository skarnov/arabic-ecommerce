                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="display-1-1">
                                        <div class="row">
                                            <div class="listview">
                                                ...
                                                <?php
                                                foreach ($special_offer as $v_special_offer) {
                                                    $product_tag = $v_special_offer->product_tag;
                                                    if ($product_tag == NULL) {
                                                        ?>
                                                        <div class="single-product">
                                                            <div class="col-md-3 col-sm-4 col-xs-12">
                                                                <div class="product-img">
                                                                    <a href="<?php echo base_url(); ?>evis_store/product_details/<?php echo $v_special_offer->product_id; ?>">
                                                                        <img class="primary-img" src="<?php echo base_url() . $v_special_offer->product_image_0; ?>" alt="Product" style="height: 200px;">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-9 col-sm-8 col-xs-12">	
                                                                <div class="product-description">
                                                                    <h5><a href="<?php echo base_url(); ?>evis_store/product_details/<?php echo $v_special_offer->product_id; ?>"><?php echo $v_special_offer->product_name; ?></a></h5>
                                                                    <div class="price-box">
                                                                        <span class="price"><?php echo $v_special_offer->product_price; ?> ريال</span>
                                                                        <span class="old-price"><?php echo $v_special_offer->product_old_price; ?> ريال</span>
                                                                    </div>
                                                                    <p class="description"><?php echo $v_special_offer->product_description; ?></p>
                                                                    <div class="product-action">
                                                                        ...
                                                                        if ($customer_id == NULL) {
                                                                            ...
                                                                            ?>
                                                                            <div class="product-button">
                                                                                <button data-toggle="modal" data-target="#smallModal" onclick="addToCart(<?php echo $v_special_offer->product_id; ?>);" style="margin-right: 12%;"><i class="fa fa-shopping-cart"></i> اضف الى السلة</button>
                                                                                <button data-toggle="modal" data-target="#Wishlist" onclick="addToWishlist(<?php echo $v_special_offer->product_id; ?>);" style="margin-right: 12%;"><i class="fa fa-heart-o"></i>القائمة المفضلة </button>
                                                                            </div>
                                                                            <?php
                                                                        }
                                                                        ?>
                                                        ...
                                                        <div class="single-product">
                                                            <div class="col-md-3 col-sm-4 col-xs-12">
                                                                <div class="label_new">
                                                                    <span class="new"><?php echo $v_special_offer->product_tag; ?></span>
                                                                </div>
                                                                <div class="product-img">
                                                                    <a href="<?php echo base_url(); ?>evis_store/product_details/<?php echo $v_special_offer->product_id; ?>">
                                                                        <img class="primary-img" src="<?php echo base_url() . $v_special_offer->product_image_0; ?>" alt="Product" style="height: 200px;">
                                                    ...
                                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                                        <div class="single-product">
                                                            ...
                                                            <div class="product-description">
                                                                <h5><a href="<?php echo base_url(); ?>evis_store/product_details/<?php echo $v_special_offer->product_id; ?>"><?php echo $v_special_offer->product_name ?></a></h5>
                                                                <div class="price-box">
                                                                    <span class="price"><?php echo $v_special_offer->product_price; ?> ريال</span><br/>
                                                                    <span class="old-price"><?php echo $v_special_offer->product_old_price; ?> ريال</span>
                                                                </div>
                                                            </div>
                                                            <div class="product-action">
