        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="<?php echo base_url(); ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>Mobile Store</b></span>
                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="user-header bg-light-blue">
                                        <img src="<?php echo base_url(); ?>asset/private/logo.jpg" alt="User Image" />
                                        <p>
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-barcode"></i> <span>Brand Managers</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url(); ?>evis_sale/add_brand"> Add New Brand</a></li>
                                <li><a href="<?php echo base_url(); ?>evis_sale/manage_brand"> Manage Brand</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
            ...
            <footer class="main-footer">
                <strong>Copyright © <a href="<?php echo base_url(); ?>">Store KSA</a></strong> All Rights Reserved.
            </footer>
        </div>
