                    ...
                    <tbody>
                        ...
                        foreach ($all_sale as $v_sale) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>evis_sale/delete_sale/<?php echo $v_sale->order_id; ?>" class="btn btn-danger" data-toggle="tooltip" title="Delete Sale" onclick="return check_delete();"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
